...
- JavaScript in `scripts/` is injected into a browser page, except `cnki_download_action.js`, which is a Playwright `run-code` function. Neither is standalone Node application code.
